...
import com.libertango.school.customer.domain.Classes;
import com.libertango.school.customer.domain.CustomerClass;
import com.libertango.school.customer.services.CustomerClassService;
...
public class CustomerClassesList {
    ...
    @GetMapping(value = "/{customerId}/classes/{classId}/delete")
